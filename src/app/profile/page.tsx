      ...
      <div className="mx-auto max-w-6xl grid gap-6 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="space-y-6">
          <div className="glass-panel-strong rounded-[32px] p-8">
            <p className="mb-3 text-[11px] uppercase tracking-[0.3em] text-zinc-500">Profile</p>
            ...
            <p className="mt-4 text-base leading-7 text-zinc-400">
              This is the first identity layer, display name, app username, avatar, and bio. Honest scope: local app identity now, shared/global registry later.
            </p>
          </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div>
                ...
                {normalizedHandle && !handleAvailable && (
                  <p className="mt-2 text-xs text-amber-400">This username is already used by a local contact in this app.</p>
                )}
              </div>
              <div>
        ...
        <div className="space-y-5">
          ...
          <div className="glass-panel rounded-[32px] p-6">
            <p className="mb-3 text-[11px] uppercase tracking-[0.3em] text-zinc-500">Auth direction</p>
            <h3 className="text-2xl font-semibold tracking-tight text-zinc-100">
              Wallet-first now, social next.
            </h3>
            <p className="mt-3 text-sm leading-7 text-zinc-500">
              The current profile is tied to this app on this device. Social login and global username ownership can come later with embedded wallets or a shared registry.
            </p>
            <div className="mt-4 rounded-[24px] border border-white/8 bg-white/[0.04] p-4 text-sm">
              ...
              <p className="mt-2 text-xs leading-6 text-zinc-500">
                Social sign-in is not live yet. Better to say that plainly than fake account abstraction.
              </p>
            </div>
          </div>
        </div>
