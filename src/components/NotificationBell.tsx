  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className="relative grid h-10 w-10 place-items-center rounded-full bg-white/20 text-[#1e293b] shadow-sm"
      >
      ...
      {open && (
        <div className="absolute right-0 top-12 z-50 w-[min(86vw,340px)] rounded-2xl border border-white/40 bg-white/95 p-3 shadow-2xl backdrop-blur">
